...
function AddMyProperty(props) {
    return <div>
        ...
        <div class="border-b border-gray-900/10 pb-12 mx-7 my-8">
            <h2 class="text-base font-semibold leading-7 text-gray-900">Personal Information</h2>
            <p class="mt-1 text-sm leading-6 text-gray-600">Use correct details of your property according to registry documents.</p>
